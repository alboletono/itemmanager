...
public class CopainsdavantTest extends AbstractCrawlTest {
	...
	public void testPeople1() throws Exception {
		...
		String filePath = "src/plugin/parse-xsl/src/tests/files/copainsdavant/people1.html";
	...
	public void testWantedPeople() throws Exception {
		...
		this.assertMetadataWantedPeople(
				...
				"Jean Michel LE CLERC Pendant les cours, je dessinai un personnage un peu bizarre sur des petits bouts de papier, notre domaine, � la sortie de l'ESD, �tait Capoulade, le boul. St-Michel... il y a 2 jours");
